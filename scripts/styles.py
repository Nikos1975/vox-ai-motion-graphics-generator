#!/usr/bin/env python3
"""
Per-era and per-theme style bible for muapi-director.
Defines theme presets, prompt compositions, and aspect routing for image/video generation.
"""
...
VIDEO_ASPECT_SUPPORT = {
    "veo3.1-image-to-video": ["16:9", "9:16"],
    "veo31-image-to-video": ["16:9", "9:16"],
    "gemini-omni-flash/image-to-video": ["16:9", "9:16"],
    "runway-image-to-video": ["16:9", "9:16", "1:1"],
    "kling-video": ["16:9", "9:16", "1:1"],
}
